...
<div id="root"></div>
	<section class="site-top-hero section-row">
		<div class="top-hero-image">
			<!--<img src="<?= get_stylesheet_directory_uri() . '/assets/images/hero/homehero.jpg'; ?>" />-->
		</div>
		<div class="caption">
			<div class="wrap">
				<div class="caption-title">
					<h2 class="title">A Growing Field, a Caring Profession</h2>
				</div>
	...
	<section class="site-optometrist section-row section-row-mobile">
		<div class="wrap">
			<div class="caption">
				<div class="caption-title">
					<h2 class="title">What does an Optometrist do?</h2>
