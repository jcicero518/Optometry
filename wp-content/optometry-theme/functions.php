...
function optometry_scripts() {
		...
		wp_enqueue_style( 'optometry-css', get_template_directory_uri() . '/dist/app.min.css', array( 'font-awesome' ), '', 'all' );
		...
		wp_enqueue_script( 'optometry-scripts-vendor', get_template_directory_uri() . '/dist/vendor.bundle.js', array(), '', true );
		wp_enqueue_script( 'optometry-scripts', get_template_directory_uri() . '/dist/app.bundle.js', array(), '', true );
